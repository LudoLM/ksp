...
import { useCalendarLogic, updateUrl, displayDateNextCoursString } from '@/utils/useCalendarLogic.ts'
import { useWindowBreakpoint } from '@/composables/useWindowBreakpoint'
...
const { isMobile } = useWindowBreakpoint(980)
...
<template>
    <CalendarHeader
        ...
        :shouldPreviousWeekDisabled=false
