      ...
      <div class="card_infos">
        ...
        <div class="min-h-24 grid items-end">
          <div class="grid grid-cols-2">
            <router-link :to="{ name: 'CoursDetails', params: { id: info.id }}" class="mt-3 mx-2 block px-3 py-2 text-center text-sm font-semibold text-violet-600 border-2 border-violet-600">
                + d'infos
            </router-link>
