...
user.value = useGetElementsToken();
  ...
  <div class="relative" ref="target">
    ...
    >
      <span class="hidden text-right lg:block">
        <span class="block text-sm font-medium text-black dark:text-white">{{ user.prenom}}</span>
        <span class="block text-xs font-medium">{{ user.roles[0].split("_")[1].toLowerCase()}}</span>
      </span>
