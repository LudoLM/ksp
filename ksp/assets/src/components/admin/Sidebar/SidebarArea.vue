  ...
  const menuGroups = ref([
    {
      ...
      menuItems: [
        ...
        },
        {
          ...
          label: 'Cours',
          children: [
                { label: 'Liste des cours', route: 'CoursAdmin' },
                { label: 'Ajouter un cours', route: 'CreateCours' },
                { label: 'Ajouter un type', route:'CreateTypeCours'},
                { label: 'Modifier un type', route:'EditTypeCours'}
...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      ...
      <button class="block" @click="sidebarStore.isSidebarOpen = true">
